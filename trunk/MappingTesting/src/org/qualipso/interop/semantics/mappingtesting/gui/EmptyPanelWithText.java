...
/**
 * An empty JPanel, having defined background, which contains only a JLabel with
 * text.
 */
public class EmptyPanelWithText extends JPanel {

    public EmptyPanelWithText(String text) {
